...
public class TwoColorsOptimizationTest {

    public static void main(String[] args) {

        ConcurrentHashMap<String, String> other_params = new ConcurrentHashMap<>();
        other_params.put("output_folder","Optimization_Results-Two-Colors");
        int num_runs = 10;

        String[] algorithms = {"RHC", "SA55", "SA75", "SA95", "GALowPop", "GAHighPop", "MIMIC200", "MIMIC50"};

        //Two Colors Test
        HashMap<String, Object> two_colors_test_params = new HashMap<>();
        two_colors_test_params.put("SA55_initial_temperature",1E11);
        two_colors_test_params.put("SA75_initial_temperature",1E11);
        two_colors_test_params.put("SA95_initial_temperature",1E11);
        two_colors_test_params.put("SA55_cooling_factor",.55);
        two_colors_test_params.put("SA75_cooling_factor",.75);
        two_colors_test_params.put("SA95_cooling_factor",.95);
        two_colors_test_params.put("GAHigh_population",600.);
        two_colors_test_params.put("GAHigh_mate_number",400.);
        two_colors_test_params.put("GAHigh_mutate_number",60.);
        two_colors_test_params.put("GALow_population",100.);
        two_colors_test_params.put("GALow_mate_number",75.);
        two_colors_test_params.put("GALow_mutate_number",10.);
        two_colors_test_params.put("MIMIC200_samples",200.);
        two_colors_test_params.put("MIMIC200_to_keep",20.);
        two_colors_test_params.put("MIMIC50_samples",50.);
        two_colors_test_params.put("MIMIC50_to_keep",5.);
